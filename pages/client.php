<hgroup>
    <h3 class="aligner txtGras">Catalogue de destinations</h3>
    <h4 class="text-muted aligner">reservation</h4>
</hgroup>
...
if (!isset($_GET['id_desti'])) {
    print "<p><br/><span class='txtGras'>Pour reserver, choisissez <a href='index.php?page=Destinations.php'>ici</a> votre destination</span></p>";
} else {
    print "<br/>Afficher ici le rappel de la reservation<br/><br/>";
    ?>
    <div class="row">
        <div class="col-xs-4 col-sm-2">
            <img src="./admin/images/gal2.jpg" alt="Votre reservation"/> 
        </div>
        <div class="col-xs-8 pull-left">
            <br/><span class="txtGras">Votre reservation : <span class="txtRouge"></span></span><br/>
        </div>
    </div>
    <br/>
    ...
    <div class="container">
        ...
        <form action="<?php print $_SERVER['PHP_SELF']; ?>" method="get" id="form_commande">
            ...
            <br/>
                    <input type="hidden" name="id_commande" value="<?php print $_GET['id_desti']; ?>"/>
                    <input type="submit" name="commander" id="commander" value="Finaliser ma reservation" class="pull-right"/>&nbsp;           
