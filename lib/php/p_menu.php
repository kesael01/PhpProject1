<nav class="navbar navbar-expand-md navbar-light">
    ...
    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
        <img src="./admin/images/gal4.jpg" alt="logo"/>
        <img src="./admin/images/gal6.jpg" alt="logoPortee"/>&nbsp;    
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a href="" class="navbar-brand collapse navbar-collapse">
            <img src="./admin/images/banVoyage2.jpg" alt="DigitArt" class="topLogo"/> 
				<br>
        </a>
	 ...
	 <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item" href="./index.php?page=Destinations.php">Destinations</a>
